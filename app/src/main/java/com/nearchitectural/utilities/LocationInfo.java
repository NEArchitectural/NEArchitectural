...
public class LocationInfo {
    ...
    private final Location coordinates; // A Location object holding the appropriate longitude and latitude
    private final List<ReportSection> fullReport; // List of ReportSection objects that provide the full report of a location

    // Location constructor
    public LocationInfo(String locationID, String name, Calendar dateOpened, int likes, double entryFee, List<Tag> tags,
        ...
        this.coordinates = new Location(name);
    ...
    public Location getCoordinates() {
        Location coordinatesCopy = new Location(coordinates);
